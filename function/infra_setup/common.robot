...
run terraform
    ...
    execute command localy    eval `ssh-agent -s` && ssh-add ${DATADIR}/id_shared && cd ${TERRAFORMDIR} && terraform apply --auto-approve -state-out=${LOGDIR}/cluster.json

configure_registration_auto_tfvars_vmware
...
set_repo_and_packages
    ...
    Set Global Variable    ${PACKAGES_LIST}    \n"ca-certificates-suse",
